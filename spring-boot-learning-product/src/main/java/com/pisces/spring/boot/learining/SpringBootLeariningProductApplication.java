package com.pisces.spring.boot.learining;
...
//表示开启Feign客户端
@EnableFeignClients
public class SpringBootLeariningProductApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringBootLeariningProductApplication.class, args);
    }
